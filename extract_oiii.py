...
fn_arr = ['allspec_fitted_emission_linelist.txt', 'all_byneb_stack_fitted_emission_linelist.txt',
          'allesi_fitted_emission_linelist.txt']
...
for line in line_arr:
    ...
    for fn in fn_arr:
        ...
        o3_table = o3_table[
            o3_table['EW_signi'] > EW_signi_thresh]  # eliminating those below detection limit i.e. EW_signi_thresh
        ...
        o3_short_table = o3_table[
            ['label', 'line_lab', 'rest_wave', 'f_line', 'f_line_u', 'f_Suplim', 'f_signi', 'EWr_fit', 'EWr_fit_u',
             'EW_signi']]
