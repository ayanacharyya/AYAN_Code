...
#----------------------------------------------------------
path = '/Users/aitcintern4/Desktop/'
...
for line in line_arr:
    ...
    for fn in fn_arr:
        ...
        o3_short_table = o3_table[['label','line_lab','rest_wave','f_line','f_line_u','f_SNR','f_Suplim','f_signi','f_redcor','f_redcor_u','f_Suplim_redcor']]
