...
def format_forbidden(label):
    forbidden = ['CIII1906', 'SiIII1882', 'OIII2320', 'OII2470', 'OII3727', 'OII3729', 'OII3727,9', 'NeIII3869',
                 'NeIII3968', \
...
if args.onlyinterv:
    ...
    tab.loc[:, 'EWr_fit'] = np.where(bad, '<' + tab.EWr_Suplim, tab.EWr_fit)
...
if 's1723' in args.shortlabel:
    tab = tab.drop(['EWr_fit', 'EWr_fit_u', 'EW_signi'], axis=1)
